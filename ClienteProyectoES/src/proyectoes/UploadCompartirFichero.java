 ...
 * @author Carlos
 */
public class UploadCompartirFichero extends javax.swing.JFrame {
     ...
     */
    public UploadCompartirFichero() {
        initComponents();
        getListaFicherosGET();
        jListNoPermitidos.setListData(DENEGADOS_listaUsuariosNombre);
    }
    
    public UploadCompartirFichero(String ficheroId) {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UploadCompartirFichero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UploadCompartirFichero().setVisible(true);
            }
        });
    }
